...
m,b);f.bind(this.f,m,c);this.U=new Scroller(this.B.bind(this),{});this.U.ab(this.scrollWidth,this.scrollHeight,this.D,this.C);c=function(a){return function(b){a.V=!0;a.U.Ya(D(b),b.timeStamp);return b.preventDefault()}}(this);b=function(a){return function(b){a.U.Xa(D(b),b.timeStamp,b.scale);return a.V=!0}}(this);a=function(a){return function(b){if(a.V)return a.U.Wa(b.timeStamp),a.V=!1}}(this);"ontouchstart"in window?(f.bind(this.a,"touchstart",c),f.bind(this.a,"touchmove",b),f.bind(this.a,"touchend",
a),f.bind(this.a,"touchcancel",a)):window.navigator.wa?(f.bind(this.a,"pointerdown",c),f.bind(this.a,"pointermove",b),f.bind(this.a,"pointerup",a),f.bind(this.a,"pointercancel",a)):window.navigator.msPointerEnabled&&(f.bind(this.a,"MSPointerDown",c),f.bind(this.a,"MSPointerMove",b),f.bind(this.a,"MSPointerUp",a),f.bind(this.a,"MSPointerCancel",a))}d.prototype.w=function(){};d.prototype.B=function(a,b){var c;c=!1;null!=a?(a=v(a,0,this.Da),this.scrollLeft!==a&&(c=!0,this.scrollLeft=a)):a=this.scrollLeft;
null!=b?(b=v(b,0,this.Ea),this.scrollTop!==b&&(c=!0,this.scrollTop=b)):b=this.scrollTop;this.g.scrollLeft=a;this.h.scrollTop=b;this.w(a,b);return c};return d}();B=function(){function d(a){var b;b=a.j;if(null==b)throw"container not specified.";if("string"===typeof b)this.j=document.querySelector(b);else if("object"===typeof b)this.j=b;else throw"Container must be a string or a dom element.";this.i(a,"painter",new A);this.i(a,"autoSetup",!0);this.i(a,"model");this.i(a,"nbRows");this.i(a,"rowHeight");
this.i(a,"columnWidths");this.i(a,"nbColsOverdraw",2);this.i(a,"nbRowsOverdraw",2);this.i(a,"columnHeaderHeight");this.i(a,"rowHeaderWidth");this.i(a,"scrollBarVisible",!0);this.i(a,"horizontalScrollbar",this.Ia);this.i(a,"verticalScrollbar",this.Ia);this.i(a,"enableDragMove",!0);this.Ha=this.Z.length;-1===(" "+this.j.className+" ").search(/\sfattable\s/)&&(this.j.className+=" fattable");this.C=this.T*this.qa;this.H=J(this.Z);this.D=this.H[this.H.length-1];this.rows={};this.v={};this.cells={};this.ka=
new G;this.ha();this.Va&&this.Ka()}d.prototype.i=function(a,b,c){if(null==a[b]){if(void 0===c)throw"Expected parameter <"+b+">";this[b]=c}else this[b]=a[b]};d.prototype.ha=function(){this.scrollWidth=this.j.offsetWidth-this.S;this.scrollHeight=this.j.offsetHeight-this.G;this.m=Math.min(K(this.H,this.scrollWidth)+this.Za,this.Z.length);this.l=Math.min((this.scrollHeight/this.T|0)+this.$a,this.qa);this.D<=this.scrollWidth&&(this.g=!1);this.C<=this.scrollHeight&&(this.h=!1)};d.prototype.va=function(a,
b){return[v(b/this.T|0,0,this.qa-this.l),v(I(this.H,a),0,this.Ha-this.m)]};d.prototype.X=function(){var a;this.ka.La();null!=(a=this.ga)&&(a.w=null);this.o.X(this);this.j.innerHTML="";return this.f=this.b=this.a=null};d.prototype.Ka=function(){var a,b,c,d,e,f,g;this.X();this.ha();this.v={};this.rows={};this.cells={};this.j.innerHTML="";this.b=document.createElement("div");this.b.className+=" fattable-header-container fattable-column-header-container";this.b.style.width=this.scrollWidth+"px";this.b.style.height=
